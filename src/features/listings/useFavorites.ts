...
export function useFavorites() {
  ...
  // 🆕 Toggle con writeBatch: crea/borra el favorito Y actualiza el contador
  // del listing en UNA sola operación atómica.
  const toggleFavorite = useCallback(
    async (listingId: string) => {
      ...
      await batch.commit();
console.log('🔥 Batch aplicado. Verificando...');
  ...
  useEffect(() => {
    ...
    const unsub = onSnapshot(
      ...
      async (snap) => {
        ...
        const listingIds = snap.docs.map(
